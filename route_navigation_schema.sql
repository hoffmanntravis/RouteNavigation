...
-- Started on 2018-05-13 22:47:32
...
--
-- TOC entry 249 (class 1255 OID 33461)
...
--
-- TOC entry 265 (class 1255 OID 33462)
...
--
-- TOC entry 225 (class 1255 OID 33597)
...
--
-- TOC entry 264 (class 1255 OID 33742)
...
--
-- TOC entry 253 (class 1255 OID 33467)
...
--
-- TOC entry 258 (class 1255 OID 33473)
...
--
-- TOC entry 246 (class 1255 OID 33474)
...
--
-- TOC entry 262 (class 1255 OID 33481)
...
--
-- TOC entry 242 (class 1255 OID 33498)
-- Name: select_location_by_addres(character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.select_location_by_addres(p_address character varying) RETURNS SETOF public.location
    LANGUAGE plpgsql
    AS $_$
...
ALTER FUNCTION public.select_location_by_addres(p_address character varying) OWNER TO postgres;

--
-- TOC entry 241 (class 1255 OID 33499)
...
--
-- TOC entry 251 (class 1255 OID 33500)
...
--
-- TOC entry 243 (class 1255 OID 33502)
...
--
-- TOC entry 259 (class 1255 OID 35061)
...
--
-- TOC entry 255 (class 1255 OID 33515)
...
--
-- TOC entry 211 (class 1259 OID 34800)
...
--
-- TOC entry 247 (class 1255 OID 34805)
...
--
-- TOC entry 210 (class 1259 OID 34794)
...
--
-- TOC entry 266 (class 1255 OID 34799)
...
--
-- TOC entry 257 (class 1255 OID 33549)
...
--
-- TOC entry 240 (class 1255 OID 33757)
...
--
-- TOC entry 238 (class 1255 OID 33693)
...
--
-- TOC entry 252 (class 1255 OID 33758)
...
--
-- TOC entry 260 (class 1255 OID 33556)
...
--
-- TOC entry 254 (class 1255 OID 35060)
-- Name: update_route_batch_metadata(integer, integer, integer, integer, double precision, interval); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_route_batch_metadata(p_id integer, p_locations_intake_count integer, p_locations_processed_count integer, p_locations_orphaned_count integer, p_total_distance_miles double precision, p_total_time interval) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION public.update_route_batch_metadata(p_id integer, p_locations_intake_count integer, p_locations_processed_count integer, p_locations_orphaned_count integer, p_total_distance_miles double precision, p_total_time interval) OWNER TO postgres;
...
--
-- TOC entry 244 (class 1255 OID 33558)
...
--
-- TOC entry 220 (class 1255 OID 34917)
-- Name: upsert_config(integer, integer, double precision, double precision, double precision, double precision, double precision, double precision, interval, integer, interval, character varying, character varying, character[]); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.upsert_config(p_origin_location_id integer DEFAULT NULL::integer, p_minimum_days_until_pickup integer DEFAULT NULL::integer, p_matrix_priority_multiplier double precision DEFAULT NULL::double precision, p_matrix_days_until_due_exponent double precision DEFAULT NULL::double precision, p_matrix_distance_from_source double precision DEFAULT NULL::double precision, p_matrix_overdue_multiplier double precision DEFAULT NULL::double precision, p_current_fill_level_error_margin double precision DEFAULT NULL::double precision, p_route_max_hours double precision DEFAULT NULL::double precision, p_oil_pickup_average_duration interval DEFAULT NULL::interval, p_maximum_days_overdue integer DEFAULT NULL::integer, p_grease_pickup_average_duration interval DEFAULT NULL::interval, p_google_directions_maps_url character varying DEFAULT NULL::character varying, p_google_api_key character varying DEFAULT NULL::character varying, p_google_api_illegal_characters character[] DEFAULT NULL::character(1)[]) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION public.upsert_config(p_origin_location_id integer, p_minimum_days_until_pickup integer, p_matrix_priority_multiplier double precision, p_matrix_days_until_due_exponent double precision, p_matrix_distance_from_source double precision, p_matrix_overdue_multiplier double precision, p_current_fill_level_error_margin double precision, p_route_max_hours double precision, p_oil_pickup_average_duration interval, p_maximum_days_overdue integer, p_grease_pickup_average_duration interval, p_google_directions_maps_url character varying, p_google_api_key character varying, p_google_api_illegal_characters character[]) OWNER TO postgres;
...
--
-- TOC entry 2788 (class 2606 OID 33630)
...
--
-- TOC entry 2782 (class 2606 OID 33622)
...
--
-- TOC entry 2784 (class 2606 OID 34793)
...
--
-- TOC entry 2786 (class 2606 OID 34773)
...
--
-- TOC entry 2792 (class 2620 OID 34286)
...
--
-- TOC entry 2791 (class 2620 OID 33947)
...
--
-- TOC entry 2790 (class 2606 OID 34811)
...
--
-- TOC entry 2789 (class 2606 OID 34806)
...
-- Completed on 2018-05-13 22:47:32
